...
@SourceType(value = "ZuoraARP", label = "Zuora",uiConfig = "zuora-layout.json")
public class ZuoraConf extends AbstractArpConf<ZuoraConf> {
  private static final String ARP_FILENAME = "arp/implementation/zuora-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.zuora.ZuoraDriver";
